...
// GormConfigStorage generic GORM configuration storage implementation
type GormConfigStorage struct {
	db *gorm.DB
}

// NewGormConfigStorage creates a GORM configuration storage instance
...
// General configuration operation methods
