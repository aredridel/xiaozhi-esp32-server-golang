...
const openAIReasoningHighOnly = withDefault([{ label: "High", value: "high" }]);
...
const editableBaseURLProviders = new Set([
  "openai",
  "ollama",
  "azure",
  "dify",
...
const catalog = {
  openai: {
    ...
    modelHint:
      "By default, official stable aliases are preferred; for locked behavior, manually enter exact snapshot model ID.",
    models: [
      createModel(
        "gpt-5.4",
        { label: "Reasoning Effort", options: openAIReasoningLatest },
        { request: openAIReasoningRequest },
      ),
      createModel(
        "gpt-5.4-pro",
        { label: "Reasoning Effort", options: openAIReasoningLatestPro },
        { request: openAIReasoningRequest },
      ),
      createModel(
        "gpt-5.4-mini",
      ...
      createModel("gpt-5-chat-latest", false, {
        hint: "ChatGPT-specific alias, suitable for compatibility with legacy workflows; new integrations should prefer mainline GPT-5.* models.",
      }),
      createModel(
        "gpt-5-pro",
        { label: "Reasoning Effort", options: openAIReasoningHighOnly },
        { request: openAIReasoningRequest },
      ),
      createModel(
        "gpt-5",
        { label: "Reasoning Effort", options: openAIReasoningStandard },
        { request: openAIReasoningRequest },
      ),
      createModel(
        "gpt-5-mini",
      ...
      createModel(
        "gpt-5.3-codex",
        { label: "Reasoning Effort", options: openAIReasoningCodexMax },
        { request: openAIReasoningRequest },
      ),
      createModel(
        "gpt-5.2-codex",
      ...
      createModel(
        "gpt-5-codex",
        { label: "Reasoning Effort", options: openAIReasoningLegacy },
        { request: openAIReasoningRequest },
      ),
      createModel(
        "gpt-5.1",
        { label: "Reasoning Effort", options: openAIReasoningCodex },
        { request: openAIReasoningRequest },
      ),
      createModel(
        "gpt-5.1-codex",
  ...
  ollama: {
    ...
    modelPlaceholder: "Select or enter model name",
    modelHint:
      "Ollama uses local or private model services; both model list and address can be customized.",
    models: [],
  ...
  azure: {
    ...
    modelPlaceholder:
      "Select official model name or enter custom deployment name",
    modelHint:
      "For Azure, enter the deployment name here; list names are mainly for reference to underlying model capabilities.",
    models: [
      createModel(
        "gpt-5.4",
        { label: "Reasoning Effort", options: openAIReasoningLatest },
      ...
      createModel("gpt-5.2-chat", false, {
        hint: "Chat models in Azure documentation are usually accessed via deployment name; availability depends on region and quota.",
      }),
      createModel(
        "gpt-5.3-codex",
        { label: "Reasoning Effort", options: openAIReasoningCodexMax },
  ...
  anthropic: {
    ...
    modelPlaceholder: "Select or enter model name",
    modelHint:
      "By default, official stable aliases are preferred; for fixed versions or regression testing, enter exact model ID with date suffix.",
    models: [
  ...
  zhipu: {
    ...
    modelPlaceholder: "Select or enter model name",
    modelHint:
      "Zhipu documentation supports controlling thinking mode via thinking.type and clear_thinking.",
    models: [
  ...
  aliyun: {
    ...
    modelPlaceholder: "Select or enter model name",
    modelHint:
      "By default, official stable aliases are preferred; to lock specific versions, manually enter model ID with date or minor version suffix.",
    models: [
      ...
      createModel("qwen3-235b-a22b-thinking-2507", aliyunThinkingConfig, {
        label: "qwen3-235b-a22b-thinking-2507 (Versioned)",
      }),
      createModel("qwen3-30b-a3b-thinking-2507", aliyunThinkingConfig, {
        label: "qwen3-30b-a3b-thinking-2507 (Versioned)",
      }),
      createModel("kimi/kimi-k2.5", aliyunThinkingConfig, {
        label: "kimi/kimi-k2.5 (Versioned)",
      }),
    ],
    fallbackThinking: {
  ...
  doubao: {
    ...
    modelHint:
      "For Doubao, prefer using official real Model ID. Currently no stable alias confirmed for universal substitution; recommended to use Model ID from console or model list.",
    models: [
      createModel(
        "doubao-seed-2-0-pro-260215",
        { label: "Reasoning Effort", options: doubaoReasoningOptions },
  ...
  siliconflow: {
    ...
    modelPlaceholder: "Select or enter model name",
    modelHint:
      "SiliconFlow documentation directly lists enable_thinking supported models; budget configuration is only shown for models listed in documentation.",
    models: [
  ...
  deepseek: {
    ...
    modelPlaceholder: "Select or enter model name",
    modelHint:
      "Official DeepSeek switches thinking mode by selecting different models: deepseek-chat is non-thinking, deepseek-reasoner is thinking.",
    models: [
...
export function resolveLLMProvider(provider, type) {
  ...
  if (
    ...
    ["ollama", "dify", "coze"].includes(normalizedType)
  ) {
...
export function resolveProviderModel(provider, modelName) {
  ...
  return (
    models.find((model) => normalizeModelName(model.value) === normalized) ||
    null
  );
}
...
export function getProviderThinkingConfig(provider, modelName) {
  ...
  return {
    ...
    clearThinkingOptions: cloneOptions(
      source.clearThinkingOptions || clearHistoryOptions,
    ),
